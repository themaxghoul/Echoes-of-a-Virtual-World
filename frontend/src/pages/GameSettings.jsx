...
import { Accessibility, ArrowLeft, Gamepad2, Globe2, Monitor, Settings2, Volume2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-obsidian text-foreground">
      ...
      <main className="mx-auto grid max-w-5xl gap-5 p-5 md:grid-cols-2">
        ...
        <section className="rounded-sm border border-border/40 bg-surface/70 p-5 md:col-span-2">
